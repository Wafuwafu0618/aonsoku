...
> = {
  ...
  'poly-sinc-long-lp': {
    id: 'poly-sinc-long-lp',
    hqplayerName: 'poly-sinc-long-lp',
    phase: 'linear',
    tapCount: 65536,
    supportedEngines: ['cpu', 'gpu'],
    supportedOutputApis: ['wasapi-exclusive', 'asio'],
  ...
  'poly-sinc-long-ip': {
    id: 'poly-sinc-long-ip',
    hqplayerName: 'poly-sinc-long-ip',
    phase: 'intermediate',
    tapCount: 65536,
    supportedEngines: ['cpu', 'gpu'],
    supportedOutputApis: ['wasapi-exclusive', 'asio'],
...
> = {
  ...
  'poly-sinc-lp': {
    id: 'poly-sinc-lp',
    displayName: 'poly-sinc-lp',
    filterId: 'poly-sinc-lp',
    targetRatePolicy: 'integer-family-max',
    preferredEngine: 'cpu',
    onFailurePolicy: 'stop-and-notify',
  },
  'poly-sinc-long-lp': {
    id: 'poly-sinc-long-lp',
    displayName: 'poly-sinc-long-lp',
    filterId: 'poly-sinc-long-lp',
    targetRatePolicy: 'integer-family-max',
    preferredEngine: 'cpu',
    onFailurePolicy: 'stop-and-notify',
  },
  'poly-sinc-long-ip': {
    id: 'poly-sinc-long-ip',
    displayName: 'poly-sinc-long-ip',
    filterId: 'poly-sinc-long-ip',
    targetRatePolicy: 'integer-family-max',
    preferredEngine: 'auto',
    onFailurePolicy: 'stop-and-notify',
  },
  'poly-sinc-gauss': {
    id: 'poly-sinc-gauss',
    displayName: 'poly-sinc-gauss',
    filterId: 'poly-sinc-gauss',
    targetRatePolicy: 'integer-family-max',
    preferredEngine: 'auto',
    onFailurePolicy: 'stop-and-notify',
  },
