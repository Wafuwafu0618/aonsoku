...
> = {
  ...
  'sinc-mega-apod': createFilter('sinc-mega-apod', 'sinc-M-apod', 'intermediate', 1_048_576),
  'sinc-mega': createFilter('sinc-mega', 'sinc-M', 'linear', 1_048_576),
  'sinc-ultra-apod': createFilter('sinc-ultra-apod', 'sinc-L-apod', 'intermediate', 2_097_152),
...
> = {
  ...
  'sinc-mega-apod': createPreset('sinc-mega-apod', 'sinc-mega-apod'),
  'sinc-mega': createPreset('sinc-mega', 'sinc-mega'),
  'sinc-ultra-apod': createPreset('sinc-ultra-apod', 'sinc-ultra-apod'),
