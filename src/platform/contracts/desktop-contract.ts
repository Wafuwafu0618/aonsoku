...
export {
  ...
  type NativeAudioAnalogColorConfig,
  type NativeAudioAnalogColorPreset,
  type NativeAudioCrossfeedConfig,
  type NativeAudioCrossfeedPreset,
  type NativeAudioParametricEqBand,
  type NativeAudioParametricEqConfig,
  type NativeAudioParametricEqFilterType,
  type SpotifyConnectCommandResult,
  type SpotifyConnectDeviceInfo,
  type SpotifyConnectErrorPayload,
  type SpotifyConnectEvent,
  type SpotifyConnectEventType,
  type SpotifyConnectInitializeRequest,
  type SpotifyConnectInitializeResult,
  type SpotifyConnectListDevicesResult,
  type SpotifyConnectOAuthAuthorizeRequest,
  type SpotifyConnectOAuthRefreshRequest,
  type SpotifyConnectOAuthTokenResult,
  type SpotifyConnectPlayUriRequest,
  type SpotifyConnectSetActiveDeviceRequest,
